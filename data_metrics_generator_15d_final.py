...
X_train_datasets_5d = load('../datasets_15d_X_train_unsampled.npy',allow_pickle = True)
y_train_datasets_5d = load('../datasets_15d_y_train_unsampled.npy',allow_pickle = True)
...
np.savetxt('Data_metrics_15d_7_features_final.csv', matrix.tolist() ,delimiter=',',fmt='%f')
